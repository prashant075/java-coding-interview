...
public class DPBoardPath {
	
	public static void main(String[] args){
		int n =20;
		System.out.println(BPBUSE(n));
		System.out.println(BPBU(0, n));
		System.out.println(BPTD(0, n, new int[n]));
		System.out.println(BPRecusion(0, n));
	}
	
	public static int BPRecusion(int curr, int end){
		...
		int count =0;
		 for(int dice =1; dice <=6; dice++){
			count +=BPRecusion(curr+ dice, end);
		}
		 return count;
	}
