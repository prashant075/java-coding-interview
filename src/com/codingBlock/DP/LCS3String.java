...
public class LCS3String {
	...
	public static void main(String[] args) {
		...
		System.out.println(LCS3StringTD(s1,s2,s3));
	}
	...
	public static int LCS3StringRec(String s1, String s2, String s3, int vidx1, int vidx2, int vidx3) {
		...
		ans= LCS3StringRec(s1, s2, s3, vidx1+1, vidx2+1, vidx3+1) +1;
			...
			int o3= LCS3StringRec(s1, s2, s3, vidx1+1, vidx2, vidx3+1);
	...
	public static int LCS3StringTD(String s1, String s2, String s3 ) {
